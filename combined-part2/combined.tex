...
H^{\otimes n} \ket{0^{\otimes n}} &= \frac{1}{\sqrt{2}^{n}} \sum \limits _{z \in \{0,1\}^{n}} \ket{z}\\\\
H^{\otimes n} \ket{x} &= \frac{1}{\sqrt{2}^{n}} \sum \limits _{z \in \{0,1\}^{n}} (-1)^{x \cdot z}\ket{z}
\end{align*}
